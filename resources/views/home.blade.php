    ...
    <section class="ai-slider-section">
      <div class="container-fluid px-0">
        ...
        <div class="col-xl-5 col-lg-6">
            ...
            <div class="dots-pattern" aria-hidden="true">
  ...
  <div class="carousel-track">
    <article class="ai-slide">
      <div class="carousel-card">
        <img src="{{ asset('images/slide-course-selector.png') }}" alt="AI Based Course Selector" draggable="false">
      </div>
    </article>
    <article class="ai-slide"> <div class="carousel-card">
       <img src="{{ asset('images/slide-scenarios.png') }}" alt="AI Based Scenarios"draggable="false">
      </div> </article>
    <article class="ai-slide"> <div class="carousel-card">
      <img src="{{ asset('images/slide-quizzes.png') }}" alt="AI Based Quizzes"draggable="false">
      </div> </article>
    <article class="ai-slide"> <div class="carousel-card">
        <img src="{{ asset('images/slide-gamification.png') }}" alt="AI Based Gamification"draggable="false">
      </div> </article>
  </div>

  <div class="carousel-dots" role="tablist" aria-label="Slides">
    <button class="carousel-dot active" aria-selected="true" aria-label="Slide 1"></button>
    <button class="carousel-dot" aria-selected="false" aria-label="Slide 2"></button>
    <button class="carousel-dot" aria-selected="false" aria-label="Slide 3"></button>
    <button class="carousel-dot" aria-selected="false" aria-label="Slide 4"></button>
  </div>
</div>
    ...
    <section class="popular-courses">
        <div class="container">
            <h2 class="section-heading">
                <span class="text-blue">Popular</span>
                <span class="text-orange">Courses</span>
            </h2>
                    ...
                    <div class="course-card-inner">
                        ...
                        <div class="course-card-bottom">
                            ...
                            <div class="course-card-actions">
                                <a href="{{ route('course.show', $course->id) }}" class="btn-demo">
                                    <i class="fa fa-play-circle"></i>
                                    📺Live Demo
                                </a>
                                <a href="{{ route('course.show', $course->id) }}" class="btn-enroll">
                                    <i class="fa fa-user-plus"></i>
                                    📌Enroll Now
                                </a>
                            </div>
                            <a href="{{ route('course.show', $course->id) }}" class="btn-download">
